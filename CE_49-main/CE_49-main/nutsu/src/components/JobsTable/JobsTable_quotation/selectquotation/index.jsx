...
export default function selectquotation(props) {
        ...
        <tbody>
          {
            props.records.map((element, index) => (
              <tr key={index}>
                ...
                <td><button onClick={() => props.createpdf_QuotationId(element)} className="btn btn-outline btn-accent m-2">เลือกเอกสารนี้</button></td>
